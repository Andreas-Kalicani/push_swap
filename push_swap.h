...
/*   Updated: 2024/02/27 16:06:03 by akalican         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void						get_top_stack_a(t_stacks *stacks,
								t_stack_node_a *head_a, int i);
...
/* applyin1.c */
int							ft_apply_rarb(t_stack_node_a **stack_a,
								t_stack_node_b **stack_b, int c, char s);
int							ft_apply_rrarrb(t_stack_node_a **stack_a,
								t_stack_node_b **stack_b, int c, char s);
int							ft_apply_rrarb(t_stack_node_a **stack_a,
								t_stack_node_b **stack_b, int c, char s);
int							ft_apply_rarrb(t_stack_node_a **stack_a,
								t_stack_node_b **stack_b, int c, char s);

/* solver_utils_ab.c */
int							ft_case_rarb(t_stack_node_a *stack_a,
								t_stack_node_b *stack_b, int c);
int							ft_case_rrarrb(t_stack_node_a *stack_a,
								t_stack_node_b *stack_b, int c);
int							ft_case_rrarb(t_stack_node_a *stack_a,
								t_stack_node_b *stack_b, int c);
int							ft_case_rarrb(t_stack_node_a *stack_a,
								t_stack_node_b *stack_b, int c);

/*solvert_utils_ba*/
int							ft_case_rarb_a(t_stack_node_a *stack_a,
								t_stack_node_b *stack_b, int c);
int							ft_case_rrarrb_a(t_stack_node_a *stack_a,
								t_stack_node_b *stack_b, int c);
int							ft_case_rarrb_a(t_stack_node_a *stack_a,
								t_stack_node_b *stack_b, int c);
int							ft_case_rrarb_a(t_stack_node_a *stack_a,
								t_stack_node_b *stack_b, int c);

/*rotate_type.c*/
int							ft_rotate_type_ba(t_stack_node_a *stack_a,
								t_stack_node_b *stack_b);
